                                        ...
                                        <div class="section-form-field">
                                            ...
                                            <div class="section-form-field__input">
                                                <input type="text" class="form-control" placeholder="Last name"
                                                    aria-label="Last name" value="{{ $user->name }}" name="name">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="section-form-field">
                                        ...
                                        <div class="section-form-field__input">
                                            <input type="text" class="form-control" placeholder="Phone"
                                                aria-label="Phone" value="{{ $user->user_phonenumber }}" name="user_phonenumber">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="section-form-field">
                                        ...
                                        <div class="section-form-field__input">
                                            <input type="text" class="form-control" placeholder="Email"
                                                aria-label="Email" value="{{ $user->email }}" name="email">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="section-form-field">
                                        ...
                                        <div class="section-form-field__input">
                                            <input type="text" class="form-control" placeholder="Address"
                                                aria-label="Address" value="{{ $user->user_address }}" name="user_address">
                                        </div>
                                    </div>
                                </div>
                        </div>
