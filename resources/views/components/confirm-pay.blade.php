        ...
        <div class="confirm">
            ...
            <div class="bill">
                ...
                <div class="bill-contact">
                    ...
                    <div class="email-input"><input type="email" style=" width: 100%;  padding: 14px 24px;  margin: 8px 0;  box-sizing: border-box;border-radius: 12px;" placeholder="Enter your email"></div>
                </div>
                <div class="bill-contact">
                    <div class="email-title">Phone number</div>
                    <div class="email-input"><input type="email" style=" width: 100%;  padding: 14px 24px;  margin: 8px 0;  box-sizing: border-box;border-radius: 12px;" placeholder="Enter your phone number"></div>
                </div>
                <div class="bill-contact">
                    <div class="email-title">Message to host</div>
                    <div class="email-input-message"><input type="email" style=" width: 100%;height: 116px;  padding: 14px 24px;  margin: 8px 0;  box-sizing: border-box;border-radius: 12px;" placeholder="Enter your message"></div>
                </div>
