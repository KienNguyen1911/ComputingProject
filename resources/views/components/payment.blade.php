...
<body>
    ...
    <div class="container">
        ...
        <div class="confirm-pay-container" style="margin-inline: auto; margin-top: 100px; margin-bottom: 100px;">
            <div class="confirm">
                ...
                <div class="bill">
                    ...
                    <div class="confirm-btn" style="display: flex; justify-content: space-between">
                        <button class="button-btn"
                            style="border: 0.1px solid rgb(95, 95, 95); border-radius: 24px; width: 176px;height:48px ;">
                            Confirm
                        </button>
            ...
            @endphp
            <div class="pay">
                <form action="{{ route('postPayment', ['id'=>$data->id]) }}" method="POST">
                    @csrf
                    <div class="pay-title">
                        <div class="pay-img"><img
                                style="border-radius: 24px; width: auto; width: 180px; height: 180px; object-fit:cover"
                    ...
                    <div class="payment"
                        style="display: flex; margin-top: 30px; justify-content: space-between; border-top: 1px solid #777e9042; padding-top: 10px">
                        <h4 style="font-weight: 600">Using VNPay</h4>
